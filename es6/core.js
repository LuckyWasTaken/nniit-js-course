...
console.log(dic.addWord("map","отображения"));
console.log(dic.addWord(77,"аааа"));
console.log(dic.getValue("map"));
console.log(dic.getValue("book"));
console.log(dic.deleteWord("map"));
console.log(dic.deleteWord("book"));
