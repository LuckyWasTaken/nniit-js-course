...
describe("Структуры данных", () => {
  describe("#capitalize", () => {
    it("Корректно отрабатывает", () => {
      ...
      it("Корректно отрабатывает (со звездочкой)", () => {
        assert.equal(core.capitalize("Подходит Петька к Василиванычу и спрашивает"), "Подходит Петька К Василиванычу И Спрашивает");
      })
  });
